...
/**
 * Job card (PLAN §6, §11.4): location first, salary large in tabular
 * figures with approx-£ beneath, "after tax" pill where true, the two
 * strongest benefits, posted date. Rendered inside the /jobs index (a
 * client component) and reusable on the server-rendered home page.
 */
