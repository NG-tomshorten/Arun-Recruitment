...
export default function NotFound() {
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-4 py-20 sm:px-6 sm:py-28">
      ...
      <p className="mt-6 max-w-[52ch] text-lead text-flint">
        ...
        possibly a role that has since been filled. Nothing is lost: everything
        we currently have is a click away.
      </p>
      ...
      <nav aria-label="Elsewhere on the site" className="mt-12">
        <h2 className="kicker text-flint">
