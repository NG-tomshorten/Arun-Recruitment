...
export default function Contact() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6">
      ...
      <h1 className="mt-4 max-w-[24ch] text-h1">Get in touch</h1>
      <TideLine className="mt-4 max-w-40" />
      <p className="mt-6 max-w-[62ch] text-lead text-flint">
        Send us a message with the form, or reach us directly by email or
        phone. We reply to every enquiry.
      </p>

      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)]">
        ...
        <div className="rounded-card border border-gull bg-chalk p-8 shadow-haze lg:self-start">
